...
tr:nth-child(odd) {
 ...
 <body align="center">
    ...
    <font color="Green"><h3>GOLD LOANS AVAILABLE</h3></font>
    
    
     <br><br><br><br> 
  <a align="right" href="AddLoan.jsp" >ADD NEW GOLD LOAN</a><br><br><br><br>
...
<td><%=resultSet.getString("Documents") %></td>
             ...
             <td>
                <a href="deleteLoan.jsp?SINO=<%=resultSet.getString("SINO") %>">Delete</a>
